...
export const AIMED_FIREARMS = new Set(['gun', 'machinegun', 'smg', 'shotgun', 'rocket', 'cannon', 'grapeshot', 'chain_shot', 'hot_shot', 'sonic_cannon', 'sniper_rifle', 'charge_shot', 'railgun']);
