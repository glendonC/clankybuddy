...
export const ICONS = {
  ...
  compliment:   { d: 'M -10 -7 h 20 v 11 h -8 l -4 4 v -4 h -8 z', fill: false },
  gift:         { d: 'M -10 -5.5 h 20 v 4 h -20 z M -8 -1.5 h 16 v 11 h -16 z M 0 -5.5 v 15 M -8 -5.5 c 0 -7 7 -3 8 0 c 1 -3 8 -7 8 0', fill: false },
  gpu:          { d: 'M -8 -8 h 16 v 16 h -16 z M -4 -4 h 8 v 8 h -8 z M -8 -5 h -2 M -8 -1 h -2 M -8 3 h -2 M 8 -5 h 2 M 8 -1 h 2 M 8 3 h 2 M -5 -8 v -2 M -1 -8 v -2 M 3 -8 v -2 M -5 8 v 2 M -1 8 v 2 M 3 8 v 2', fill: false },
  ...
  // ---- cataclysm (was: god) ----
  // Server rack chassis with 4 horizontal slot lines + status LED dot.
  // Replaces the anvil silhouette in Phase 2 of the 2026-05-02 redesign.
  // Same id key (`anvil`) for back-compat with the partType plumbing.
  anvil:        { d: 'M -10 -10 h 20 v 20 h -20 z M -8 -6 h 16 M -8 -2 h 16 M -8 2 h 16 M -8 6 h 16 M 7 -8 h 1 v 1 h -1 z', fill: false },
  ...
  // ---- injection / corruption add-ons ----
  // Gaslight, gas lamp silhouette with flame inside.
  gaslight:     { d: 'M -5 -10 h 10 v 4 h -10 z M -7 -6 h 14 v 12 h -14 z M -3 -3 c -2 3 1 5 0 8 c 3 -1 5 -4 3 -8', fill: false },

  // ---- cataclysm add-ons ----
  // Force-quit, terminal window with X close button.
  force_quit:   { d: 'M -11 -8 h 22 v 3 h -22 z M -11 -5 h 22 v 13 h -22 z M -9 -7 a 0.5 0.5 0 1 0 0.01 0 z M -7 -7 a 0.5 0.5 0 1 0 0.01 0 z M -5 -7 a 0.5 0.5 0 1 0 0.01 0 z M -3 0 l 6 6 M 3 0 l -6 6', fill: false },

  // ---- corruption add-ons ----
  // Mode-collapse, three converging arrows pointing inward to center.
  mode_collapse:{ d: 'M -11 -11 l 6 6 M -5 -8 v -3 h -3 M -5 -8 h -3 M 11 -11 l -6 6 M 5 -8 v -3 h 3 M 5 -8 h 3 M -11 11 l 6 -6 M -5 8 v 3 h -3 M -5 8 h -3 M 11 11 l -6 -6 M 5 8 v 3 h 3 M 5 8 h 3', fill: false },
